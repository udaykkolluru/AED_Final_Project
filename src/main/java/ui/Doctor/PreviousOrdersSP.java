 ...
 * @author harish
 */
public class PreviousOrdersSP extends javax.swing.JPanel {
     ...
     */
    public PreviousOrdersSP(JPanel userProcessConatiner, Enterprise enterprise,UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblRequest.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sender", "Sender Enterprise", "Status"
            }
        ));
        jScrollPane1.setViewportView(tblRequest);

        add(jScrollPane1);
        jScrollPane1.setBounds(131, 64, 794, 182);
        ...
        add(jScrollPane2);
        jScrollPane2.setBounds(131, 402, 794, 160);
        ...
        add(btnOrderDetails);
        btnOrderDetails.setBounds(470, 304, 127, 29);
